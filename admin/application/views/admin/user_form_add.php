                ...
                <?php //echo validation_errors(); ?>
                    <form action="" method="post">
                        <div class="form-group <?=form_error('fullname') ? 'has-error' : null ?>">
                            ...
                            <input type="text" name="fullname" value="<?=set_value('fullname');?>" id="nama" class="form-control">
                            <?=form_error('fullname');?>
                        </div>
                        ...
                        <div class="form-group <?=form_error('passconf') ? 'has-error' : null ?>">
                            ...
                            <input type="password" name="passconf" value="<?=set_value('passconf');?>" id="passconf" class="form-control">
                            <?=form_error('passconf');?>
                        </div>
                        <div class="form-group <?=form_error('address') ? 'has-error' : null ?>">
                            <label for="address">Alamat *</label>
                            <textarea name="address" class="form-control" id="address"><?=nl2br(set_value('address'));?></textarea>
                            <?=form_error('address');?>
                        </div>
